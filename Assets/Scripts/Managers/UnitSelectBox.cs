...
public class UnitSelectBox : MonoBehaviour
{
    ...
    private void Update()
    {
        //TODO: Checking the mouse input when click, drag and release
        // When Clicked
        ...
        {
            //TODO: Checking if the width or height of the box is bigger than 0
            if (boxVisual.rect.width > 0 || boxVisual.rect.height > 0)  //if it is = 0, it means that there was no box
            {
                //TODO: Deselect the units if the box is not over the units
